...
* @Last modified time: 2017-05-19T15:32:00+08:00
* @License: MIT
...
function createEva() {
  ...
  return function eva() {
    ...
    function init() {
      ...
      var appInstance = (0, _utils.createInstance)(MODE, LOGFILE);
    ...
    function model(namespace, ms) {
      ...
      var realSchema = new mongoose.Schema(schema, options);
      realSchema.methods = (0, _utils.mapObject)(methods, function (name, em) {
      ...
      realSchema.statics = (0, _utils.mapObject)(statics, function (name, em) {
        return function method() {
      ...
      (0, _utils.mapObject)(virtuals, function (name, em) {
        return realSchema.virtual(name).get(function () {
          return em(vUtils);
        });
      });
    ...
    function renderRoutes(namespace, routes) {
      ...
      routes, function (_, methodObject) {
        ...
        return (0, _utils.mapObject)(methodObject, function (_, methodMHs) {
          // eslint-disable-line
          var _ref2 = [methodMHs.slice(0, -1)].concat((0, _toConsumableArray3.default)(methodMHs.slice(-1))),
              middlewares = _ref2[0],
              endHandler = _ref2[1];
    ...
    function start() {
      ...
      instance.listen(server.PORT, server.HOST || 'localhost', function (err) {
        /* eslint-disable */
        if (err) {
          console.log(err);
        } else {
