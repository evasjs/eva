...
function createMethod(methodObject, namespace, name, extraMethodObject) {
  ...
  if (extraMethodObject) {
    if (!methodObject[rNs][rHn]) {
      ...
      (0, _warning2.default)(methodObject[rNs][rHn] || !extraMethodObject[rNs][rHn], 'You had better create method ' + rHn + ' as handler in ' + rNs);
    } else {
...
function createInstance(env, log) {
  ...
  instance.use((0, _helmet2.default)());
  ...
  instance.use((0, _connectMultiparty2.default)());
  instance.use((0, _compression2.default)());
